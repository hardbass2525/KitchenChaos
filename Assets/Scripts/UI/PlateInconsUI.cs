...
public class PlateInconsUI : MonoBehaviour
{
    ...
    private void UpdateVisual()
    {
        ...
        {
            if (child.gameObject == iconTemplate.gameObject) continue;
        ...
        foreach (KitchenObjectSO kitchenObjectSO in plateKitchenObject.GetKitchenObjectSOList())
        {
            ...
            iconTransform.GetComponent<PlateIconSingleUI>().SetKitchenObject(kitchenObjectSO);
        }
    }
}
